...
- **Command**:
  ```powershell
  PS C:\Users\Admin\Desktop> .\test_config.ps1
  ```
...
- **Command**:
  ```powershell
  PS C:\Users\Admin\Desktop> .\CheckTomcatConfig.ps1
  ```
- **Example Output** (secure setup):
  ```
...
- ### Adding Test Users
  Edit `tomcat-users.xml` to include users, e.g.:
  ```xml
  <tomcat-users>
